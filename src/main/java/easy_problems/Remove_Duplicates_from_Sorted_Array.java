...
/**
 * 26. Remove Duplicates from Sorted Array Given a sorted array nums, remove the
 ...
 * values are set beyond the returned length. Clarification:
 * 
...
public class Remove_Duplicates_from_Sorted_Array {
	...
	public static void main(String[] args) {
		...
		len = array.removeDuplicates(nums);
		System.out.println(len);
		System.out.println(Arrays.toString(nums));
	}
}
